...
export const KakaoIcon = ({ size = 24 }: { size?: number }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24">
    <Path
      d="M12 3C6.47715 3 2 6.48364 2 10.7828C2 13.5647 3.82946 15.9892 6.5828 17.4107L5.5 21.5L9.83333 18.618C10.5312 18.847 11.2656 18.9656 12 18.9656C17.5228 18.9656 22 15.4819 22 11.1828C22 6.88364 17.5228 3 12 3Z"
      fill="#3C1E1E"
    />
  </Svg>
);
